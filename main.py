...
if __name__ == '__main__' :
    ...
    openfile.setFont(QFont('Arial', 10))
    ...
    box_x.setMinimum(10)
    box_x.setValue(1024)
    box_x.setFont(QFont('Arial', 10))
    box_x.setStyleSheet("color:white;")
    ...
    box_y.setMinimum(10)
    box_y.setValue(512)
    box_y.setFont(QFont('Arial', 10))
    box_y.setStyleSheet("color:white;")
    ...
    box_arch.setFont(QFont('Arial', 10))
    box_arch.setStyleSheet("color:white;")
