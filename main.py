...
if __name__ == '__main__' :
    ...
    label1.setFont(QFont('Arial', 10, QFont.White))
    openfile = QPushButton("Select File", widget)
    openfile.setFont(QFont('Arial', 10, QFont.White))
